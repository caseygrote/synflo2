...
class Menu {
 public:
	...
	const struct MenuAssets *assets;
...
//    const struct MenuAssets *assets; // theme assets of the menu @EV MODIFIED THIS AS WELL
    uint8_t numTips;                // number of tips in the theme
   // struct MenuItem *items;         // items in the strip @EV MODIFIED THIS
